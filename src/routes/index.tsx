...
const PROJECTS: Project[] = [
  { title: "AI Phishing Email Detector", desc: "ML/NLP classifier in Python achieving 90%+ accuracy on real-world phishing emails.", tags: ["Python", "ML", "NLP"], category: "AI", demo: "https://phiishguard-ai.netlify.app", repo: "https://github.com/muniba093/phishguard-ai", img: "https://images.unsplash.com/photo-1563206767-5b18f218e8de?auto=format&fit=crop&w=900&q=70" },
...
{  title: "Crunzify", desc: "Full-stack restaurant ordering platform with responsive UI, menu management, online ordering, authentication, and Supabase database integration.", tags: ["React", "TypeScript", "Tailwind CSS", "Supabase"], category: "Web",  demo: "https://crunzify.vercel.app", repo: "https://github.com/muniba093/Crunzify", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoASzBE5QldXVeqbuTuRFAvZIjUle-WevBXVNQs-d7RA&s=10"},
    { title: "Portfolio Website", desc: "Modern responsive portfolio with glassmorphism, 3D tilt cards and smooth animations.", tags: ["React", "Tailwind"], category: "Web", demo: "https://munibaportfolio.netlify.app/", repo: "https://github.com/muniba093/MunibaAkram-Portfolio", img: "https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?auto=format&fit=crop&w=900&q=70" },
];
